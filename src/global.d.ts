...
declare global {
  ...
  interface IRequestConfig<T = TResponseData, D = TRequestData> extends UanRequestConfig<T, D>, IBaseConfig<T, D> {}

  interface IDownloadConfig<T = TResponseData, D = TRequestData> extends UanDownloadConfig<T, D>, IBaseConfig<T, D> {}

  interface IUploadConfig<T = TResponseData, D = TRequestData> extends UanUploadConfig<T, D>, IBaseConfig<T, D> {}

  type TConfig = IBaseConfig<T, D> | IRequestConfig<T, D> | IDownloadConfig<T, D> | IUploadConfig<T, D>

  /* response */
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  interface IBaseResponse<T = TResponseData, D = TRequestData> extends UanBaseResponse<T, D> {}

  interface IRequestResponse<T = TResponseData, D = TRequestData> extends UanRequestResponse<T, D>, IBaseResponse<T, D> {}

  interface IDownloadResponse<T = TResponseData, D = TRequestData> extends UanDownloadResponse<T, D>, IBaseResponse<T, D> {}

  interface IUploadResponse<T = TResponseData, D = TRequestData> extends UanUploadResponse<T, D>, IBaseResponse<T, D> {}

  type TResponse = IBaseResponse<T, D> | IRequestResponse<T, D> | IDownloadResponse<T, D> | IUploadResponse<T, D>
  ...
  type TError<T = TResponseData, D = TRequestData> = IBaseError<T, D> | IRequestConfig<T, D> | IDownloadConfig<T, D> | IUploadConfig<T, D>
}
